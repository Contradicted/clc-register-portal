...
export const StepOneForm = ({
    ...
    const onNext = () => {
      ...
      if (currentValues.tuitionFees === "Student Loan Company England (SLC)") {
        if (
    ...
    useEffect(() => {
      ...
      if (watchNationality === "British") {
        ...
        form.setValue("entryDateToUK", null);
      }
    ...
    // Add new effect for handling entry date and immigration status visibility
    useEffect(() => {
                    ...
                    <DialogContent className="sm:max-w-[600px]">
                      ...
                      <ScrollArea className="max-h-[80vh] pr-4">
                        <div className="space-y-4">
                          ...
                          <p className="text-sm text-muted-foreground">
                            If you&apos;re using a photo taken on your own
                            device, include your head, shoulders and upper body.
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            your eyes are not covered by the frames or any
                                  ...
                                  <SelectTrigger
                                    className={cn(
                                      form.formState.errors
                                        .immigration_status && "border-red-500"
                                    )}
                                  >
                                    <SelectValue placeholder="Select an option" />
                                  </SelectTrigger>
                                  ...
                                  <FormField
                                    ...
                                    render={({ field }) => (
                                      <FormItem className="space-y-3">
                                        <FormLabel>
                                          Do you have an account with the
                                    ...
                                    <>
                                      ...
                                      {form.watch("previouslyReceivedFunds") ===
                                        ...
                                        <FormField
                                          ...
                                          render={({ field }) => (
                                            <FormItem>
                                              <FormLabel>
                                                During which academic year did
                                                you receive funding?
                                              </FormLabel>
                                              <FormControl>
                                                <Select
                                      ...
                                      <FormField
                                        ...
                                        render={({ field }) => (
                                          <FormItem className="space-y-3">
                                            <FormLabel>
                                              Have you applied for SLC funding
                                              for this course?
                                            </FormLabel>
                                            <FormControl>
                                              <RadioGroup
