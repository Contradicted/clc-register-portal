      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-5">
          <div className="flex flex-col text-left">
            <h1 className="font-semibold text-[20px]">Marketing Information</h1>
                              ...
                              <ScrollArea className="flex-grow overflow-auto">
                                <div className="p-6 text-sm">
                                  ...
                                  <p className="mb-4">
                                    ...
                                    including our refund and compensation
                                    policy, please refer to our official
                                    document:
                                  </p>
                                  <p className="mb-4">
                                    <Link
                                  ...
                                  <p className="mb-4">
                                    ...
                                    regarding tuition fees, refunds, and
                                    potential compensation. We encourage all
                                    students to review this document carefully
                                    to understand their rights and
                                    responsibilities concerning financial
                                    matters related to their education at CLC.
                                  </p>
                                  ...
                                  <ul className="list-disc pl-6 mb-4 space-y-2">
                                    ...
                                    <li>
                                      promote the spirit of mutual respect,
                                      order and decorum within the College
                                      environment and between students and
                                      staff;
                                    </li>
                                    <li>
                                  ...
                                  <ul className="list-disc pl-6 mb-4 space-y-2">
                                    ...
                                    <li>
                                      appropriately high standards of teaching
                                      and assessment, support, advice and
                                      guidance and regular continuing
                                    ...
                                    <li>
                                      ...
                                      programme management, including elections
                                      of student representatives;
                                    </li>
                                    <li>
                                      access to sources of support such as
                                      counselling and advice on health and
                                      safety; accommodation; finance and
                                      careers;
                                    </li>
                                    <li>
                                  ...
                                  <ul className="list-disc pl-6 mb-4 space-y-2">
                                    <li>
                                      ...
                                      contacts, assessment criteria, contact
                                      hours and mode of delivery;
                                    </li>
                                    <li>
                                      with the exception of dissertations and
                                      exams, you will receive individual
                                      feedback on your assessed work within four
                                      weeks;
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      ...
                                      the campus, introduce you to other
                                      students, and provide an introduction to
                                      your studies, available resources and key
                                      College contacts;
                                    </li>
                                    <li>
                                      student handbook covering your programme
                                      and module details such as assessment
                                      criteria, contact hours, mode of delivery
                                      of the programme, examination arrangements
                                      together with general College guidance on
                                      regulations, academic and pastoral
                                      support, appeals and complaints procedures
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      ...
                                      timeframes for feedback on submitted work
                                      in programme information;
                                    </li>
                                    <li>
                                      College information which details
                                      examination arrangements and regulations,
                                      academic guidance and support on appeals
                                  ...
                                  <ul className="list-disc pl-6 mb-4 space-y-2">
                                    ...
                                    <li>
                                      ...
                                      assignments by agreed dates and that you
                                      own your work;
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      ...
                                      sessions and activities including all
                                      group tutorials;
                                    </li>
                                    <li>
                                      attend meetings with tutors, scheduled
                                      classes, submit assessed work by stated
                                      deadlines, actively participate in
                                      feedback received and ensure you spend
                                    ...
                                    <li>
                                      ...
                                      College attendance policy and
                                      programme-specific attendance policy;
                                    </li>
                                    <li>
                                      have a willingness to undertake
                                      independent study and research;
                                    </li>
                                    <li>
                                      engage with the information provided by
                                      the College taking full advantage of the
                                      services provided;
                                    </li>
                                    <li>
                                      understand the terms and conditions of
                                      being a CLC student and obligations
                                      regarding fees and payments;
                                    </li>
                                    <li>
                                      keep all your contact details up-to-date
                                      and inform the College immediately of any
                                    ...
                                    <li>
                                      ...
                                      towards our neighbours and as a
          ...
          <div className="relative w-[800px] h-[200px]">
            <SignaturePad
              ...
              canvasProps={{
                className:
                  "border border-[#F5F5F5] rounded-[5px] touch-none object-contain",
                style: {
                  width: "800px",
                  height: "200px",
                },
