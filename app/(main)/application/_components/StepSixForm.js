...
export const StepSixForm = ({
    ...
    useEffect(() => {
        ...
        } else if (application?.signature) {
            setSignature(application.signature)
        }
    }, [fData, application])

    useEffect(() => {
        // Draw the signature on the canvas when the component mounts or signature changes
    ...
    const onSubmit = async () => {
        ...
        const currentValues = {
            ...
            recruitment_agent: isRecruitmentAgent ? recruitmentAgentName : null,
